...
# 12 "src/kdtree_method.c" 2
# 1 "include/image.h" 1
# 13 "src/kdtree_method.c" 2
# 1 "include/color_table.h" 1
# 14 "src/kdtree_method.c" 2
# 1 "include/nearest.h" 1
# 18 "include/nearest.h"
...
int main (int argc,char *argv[]){
    ...
    for (i=0;i<length_im; i++){
        ...
        kdtree best = 
# 37 "src/kdtree_method.c" 3 4
                     ((void *)0)
# 37 "src/kdtree_method.c"
                         ;
