...
# 65 "src/image.c"
 "self"
# 65 "src/image.c" 3 4
 , "src/image.c", 65, __extension__ __PRETTY_FUNCTION__); }))
# 65 "src/image.c"
 ;;
...
# 79 "src/image.c"
 "dim >0 && dim <=3"
# 79 "src/image.c" 3 4
 , "src/image.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "src/image.c"
                          ;
...
# 217 "src/image.c"
 "private_valide(self,i,j)"
# 217 "src/image.c" 3 4
 , "src/image.c", 217, __extension__ __PRETTY_FUNCTION__); }))
# 217 "src/image.c"
                                 ;
...
# 218 "src/image.c"
 "comp>=0&& comp<3"
# 218 "src/image.c" 3 4
 , "src/image.c", 218, __extension__ __PRETTY_FUNCTION__); }))
# 218 "src/image.c"
                         ;
...
# 262 "src/image.c"
 "self"
# 262 "src/image.c" 3 4
 , "src/image.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "src/image.c"
             ;
...
# 263 "src/image.c"
 "buf"
# 263 "src/image.c" 3 4
 , "src/image.c", 263, __extension__ __PRETTY_FUNCTION__); }))
# 263 "src/image.c"
            ;
...
# 264 "src/image.c"
 "private_valide(self,i,j)"
# 264 "src/image.c" 3 4
 , "src/image.c", 264, __extension__ __PRETTY_FUNCTION__); }))
# 264 "src/image.c"
                                 ;
...
# 275 "src/image.c"
 "self"
# 275 "src/image.c" 3 4
 , "src/image.c", 275, __extension__ __PRETTY_FUNCTION__); }))
# 275 "src/image.c"
             ;
...
# 276 "src/image.c"
 "buf"
# 276 "src/image.c" 3 4
 , "src/image.c", 276, __extension__ __PRETTY_FUNCTION__); }))
# 276 "src/image.c"
            ;
...
# 277 "src/image.c"
 "private_valide(self,i,j)"
# 277 "src/image.c" 3 4
 , "src/image.c", 277, __extension__ __PRETTY_FUNCTION__); }))
# 277 "src/image.c"
                                 ;
