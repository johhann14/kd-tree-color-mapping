# 0 "src/color_table.c"
# 1 "/home/munsu/Documents/school/1A/algo/proj_traitement_img/OUAZZANI_LY//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/color_table.c"
# 10 "src/color_table.c"
...
# 13 "src/color_table.c" 2
# 1 "include/color_table.h" 1
# 14 "include/color_table.h"
# 1 "include/image.h" 1
# 15 "include/color_table.h" 2
...
color_table create_color_table(image im){
    ...
    if ((im == 
# 59 "src/color_table.c" 3 4
              ((void *)0)
# 59 "src/color_table.c"
                  ) || (tailleLigne%3 != 0)){
        printf("probleme");
        return 
# 61 "src/color_table.c" 3 4
              ((void *)0)
# 61 "src/color_table.c"
                  ;
    }
...
# 122 "src/color_table.c" 3 4
  ((void) sizeof ((
# 122 "src/color_table.c"
  offset< table->nb_color && size<=table->nb_color
# 122 "src/color_table.c" 3 4
...
# 122 "src/color_table.c"
  "offset< table->nb_color && size<=table->nb_color"
# 122 "src/color_table.c" 3 4
  , "src/color_table.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "src/color_table.c"
                                                          ;
   
# 123 "src/color_table.c" 3 4
  ((void) sizeof ((
# 123 "src/color_table.c"
  offset+size <= table->nb_color
# 123 "src/color_table.c" 3 4
  ) ? 1 : 0), __extension__ ({ if (
# 123 "src/color_table.c"
  offset+size <= table->nb_color
...
# 123 "src/color_table.c"
  "offset+size <= table->nb_color"
# 123 "src/color_table.c" 3 4
  , "src/color_table.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "src/color_table.c"
                                        ;
...
int color_table_get_nb_color(color_table table){
   if (table == 
# 136 "src/color_table.c" 3 4
               ((void *)0)
# 136 "src/color_table.c"
                   ){
        return -1;
    }
...
# 145 "src/color_table.c" 3 4
   ((void) sizeof ((
# 145 "src/color_table.c"
   table !=
# 145 "src/color_table.c" 3 4
...
# 145 "src/color_table.c"
   "table !=NULL"
# 145 "src/color_table.c" 3 4
   , "src/color_table.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "src/color_table.c"
                       ;
    
# 146 "src/color_table.c" 3 4
   ((void) sizeof ((
# 146 "src/color_table.c"
   indice<table->nb_color
# 146 "src/color_table.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 146 "src/color_table.c"
   indice<table->nb_color
...
# 146 "src/color_table.c"
   "indice<table->nb_color"
# 146 "src/color_table.c" 3 4
   , "src/color_table.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "src/color_table.c"
                                 ;
...
# 155 "src/color_table.c" 3 4
   ((void) sizeof ((
# 155 "src/color_table.c"
   couleur>=0 && couleur <= 2
# 155 "src/color_table.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 155 "src/color_table.c"
...
# 155 "src/color_table.c"
   "couleur>=0 && couleur <= 2"
# 155 "src/color_table.c" 3 4
   , "src/color_table.c", 155, __extension__ __PRETTY_FUNCTION__); }))
# 155 "src/color_table.c"
                                      ;
    int i;
    int j;
...
int color_table_give_nb_color(color_table table){
    if (table == 
# 177 "src/color_table.c" 3 4
                ((void *)0)
# 177 "src/color_table.c"
                    ){
        return -1;
